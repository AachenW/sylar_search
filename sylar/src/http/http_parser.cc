...
static sylar::ConfigVar<uint64_t>::ptr g_http_request_buffer_size = 
        sylar::Config::Lookup("http.request.buffer_size", (uint64_t)(4 * 1024),
...
static sylar::ConfigVar<uint64_t>::ptr g_http_response_buffer_size = 
        sylar::Config::Lookup("http.response.buffer_size", (uint64_t)(4 * 1024),
...
struct _RequestSizeIniter {
    _RequestSizeIniter() {
        ...
        g_http_request_buffer_size->addListener([](const uint64_t &old_value, 
