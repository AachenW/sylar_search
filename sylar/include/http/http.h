...
public:
    ...
    typedef std::map<std::string, std::string, CaseInsensetiveLess> MapType;
    ...
    void setHeader(const MapType &v) { m_headers = v;}
    void setParam(const MapType &v) { m_params = v;}
